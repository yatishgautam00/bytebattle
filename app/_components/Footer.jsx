    ...
    <footer className="bg-white  backdrop-blur-md bg-opacity-10">
      <div className="mx-auto max-w-5xl px-4 text-white py-16 sm:px-6 lg:px-8">
        ...
        <p className="mx-auto mt-6 max-w-xl text-center leading-relaxed text-slate-200">
          Our hackathon brings together innovators and problem solvers to create
          impactful solutions. We focus on fostering creativity, collaboration,
          and technological advancement to shape a better future.
        </p>

        <ul className="mt-12 flex justify-center gap-6 md:gap-8">
          <li>
            <Link
              href="https://www.facebook.com/yatish.gautam.359"
              rel="noreferrer"
              target="_blank"
          ...
          <li>
            <Link
              href="https://www.instagram.com/yatish_gautam/"
              rel="noreferrer"
              target="_blank"
              className="text-gray-300 transition hover:text-gray-300/75"
            >
          ...
          <li>
            <Link
              href="https://github.com/yatishgautam00"
              rel="noreferrer"
              target="_blank"
              className="text-gray-300 transition hover:text-gray-300/75"
            >
          ...
          <li>
            <Link
              href="https://www.linkedin.com/in/yatish-gautam/"
              rel="noreferrer"
              target="_blank"
              className="text-gray-300 transition hover:text-gray-300/75"
            >
